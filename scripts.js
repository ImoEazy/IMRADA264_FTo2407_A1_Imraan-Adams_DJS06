//1. ForEach Basics
// Log each name and each province to the console. Then log each name with a matching province in the format "Name (Province)".
...
//aim; Use reduce to transform the names array into an object mapping names to their respective provinces.
...
//1. Log Products
//Aim: Iterate over the products array, logging each product name.
...
//Aim: Filter out products with names longer than 5 characters.
console.log(products.filter(product => product.product.length <= 5));

//3. Price Manipulation
//Aim: Filter out products without prices, convert string prices to numbers, and calculate the total price using reduce.
...
//Aim: Use reduce to concatenate all product names into a single string.
console.log(products.reduce((acc, product) => acc + product.product + ' ', '').trim());

//5. Find Extremes in Prices
//Aim: Identify the highest and lowest-priced items, returning a string formatted as "Highest: X. Lowest: Y."
...
//Aim: Using Object.entries and reduce, recreate the products object with keys 'name' and 'cost', maintaining their original values.
